...
public class Menu {
    ...
    public Menu() {
        ...
        items.put("salad_fruit", new Salad("Fruit Salad", 6.50));
        items.put("salad_egg", new Salad("Egg Salad", 7.00));
        ...
        items.put("sandwich_egg", new Sandwich("Egg Sandwich", 8.75));
        ...
        items.put("drink_coffee", new Drink("Coffee", 3.00));
        items.put("drink_apple", new Drink("Apple Juice", 2.50));
    }
